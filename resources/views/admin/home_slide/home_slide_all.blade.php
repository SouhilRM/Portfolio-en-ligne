        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-5">Edit Home Slide</h4>
                    ...
                    <form method="POST" action="{{ route('update.slide') }}" enctype="multipart/form-data">
                        ...
                        <!-- petite remarque tu pouvais ausi passer l'id à linterieur de la balise form dans le champs action comme suit : action="{{ route('update.slide',$homeslide->id) }}" -->
                        ...
                        <!-- end row -->
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-1 col-form-label ps-3">Video URL</label>
                            <div class="col-sm-11">
                        ...
                        <!-- end row -->
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-1 col-form-label ps-3">Home Image</label>
                            <div class="col-sm-11">
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-sm-11">
                                <img id="showImage" class="rounded avatar-lg" width="400" height="400" src="{{ ( !empty( $homeslide->home_slide ) ) ? url($homeslide->home_slide) : url('upload/no_image.jpg') }}" alt="Card image cap" data-holder-rendered="true" name="home_slide">
                            </div>
                        </div>
                        <!--boutton d'envoie-->
                        <div class="row mb-3">                      
                            <div class="">
                                <button type="submit" class="btn btn-info" value="Update Slide">Update Home Slide</button>
                            </div>
                        </div>
                    </form>
                </div>
