        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-5">Edit Portfolio Page</h4>
                    ...
                    <form method="POST" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-11">
                                <input class="form-control" type="text" value="{{ $portfolio->portfolio_name }}" name="name">
                                    @error('name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-11">
                                <input class="form-control" type="text" value="{{ $portfolio->portfolio_title }}" name="title">
                                    @error('title')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-11">
                                <textarea id="elm1" class="form-control" name="description">{{ $portfolio->portfolio_description }}</textarea>
                                    @error('description')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-sm-11">
                                <img id="showImage" class="rounded avatar-lg" width="400" height="400" src="{{ url($portfolio->portfolio_image) }}" data-holder-rendered="true" name="image">
                            </div>
                        </div>
                        <!--boutton d'envoie-->
                        <div class="row mb-3">                      
                            <div class="">
                                <button type="submit" class="btn btn-info" value="Add Portfolio">Update Portfolio</button>
                            </div>
                        </div>
                    </form>
                </div>
