                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @foreach($feedback as $item)
                            <tr class="align-middle">
                                ...
                                <td><img src="{{ asset($item->image) }}" alt="PortfolioImage" style="height: 100px;"></td>

                                <td>
                                    <!-- tu passe l'id de ton image via la route pour edit et delete -->
                                    <a href="{{ route('edit.feedback',$item->id) }}" class="btn btn-info sm" title="edit"><i class="fas fa-edit"></i></a>

                                    <a href="{{ route('delete.feedback',$item->id) }}" class="btn btn-danger sm" title="delete" id="delete"><i class="fas fa-trash-alt"></i></a>
                                </td>
