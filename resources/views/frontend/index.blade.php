    ...
    <div class="container">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-6 col-md-8">
                    <div class="section__title">
                        ...
                        <h2 class="title">Creates amazing digital identity</h2>
                    </div>
                </div>
        ...
        <div class="row gx-0 services__active">
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a><img src="{{ asset('frontend/assets/img/images/montagevideo.jpg') }}" height="240px" width="323px" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                            <img class="light" src="{{ asset('frontend/assets/img/icons/services_light_icon05.png') }}" alt="">
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon05.png') }}" alt="">
                        </div>
                        <h3 class="title"><a>Video Editing</a></h3>
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a><img src="{{ asset('frontend/assets/img/images/logo.jpg') }}" height="240px" width="323px" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a><img src="{{ asset('frontend/assets/img/images/poster.jpg') }}" height="240px" width="323px" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                            <img class="light" src="{{ asset('frontend/assets/img/icons/services_light_icon07.png') }}" alt="">
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon07.png') }}" alt="">
                        </div>
                        <h3 class="title"><a>Posters</a></h3>
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a><img src="{{ asset('frontend/assets/img/images/webdesigne.jpg') }}" height="240px" width="323px" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                        ...
                        <h3 class="title"><a>Web Design</a></h3>
