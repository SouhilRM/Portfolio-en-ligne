        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about__content">
                    ...
                    <a href={{ route('download.cv') }} class="btn">Download my resume</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="about__info__wrap">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                            ...
                            <!-- tu met ca comme ca ici pour qu'il le prenne en compte -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="about__skill__item">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" style="width: 70%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><span class="percentage">70%</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
